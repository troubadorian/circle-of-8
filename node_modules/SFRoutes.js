...
var UserDefinedControllers = require("../controllers/MyControllers");
var exportable = null;
...
function DefaultRootViewController (request, response, query, hash) {
	...
	response.write("<html><head></head><body><h1>Root Folder</h1></body></html>");
	response.end();
}
...
function DefaultFallback (request, response, query, hash) {
	...
	response.write('404 Page not found', 'utf8');
	response.end();
}
